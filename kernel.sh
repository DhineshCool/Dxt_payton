...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	git clone --depth 1 --no-single-branch https://github.com/DhineshCool/AnyKernel3.git -b new
	msg "|| Cloning libufdt ||"
...
tg_post_msg() {
	curl -s -X POST "$BOT_MSG_URL" -d chat_id="-1001495665782" \
